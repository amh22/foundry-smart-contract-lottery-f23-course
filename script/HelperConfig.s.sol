...
contract HelperConfig is Script {
    ...
    constructor() {
        if (
            block.chainid == 11155111 // The Sepolia chain ID
        ) {
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        uint96 baseFee = 0.25 ether; // Is actually 0.25 LINK
        ...
        return NetworkConfig({
            ...
            gasLane: 0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c, // Doesn't matter, leave as is
